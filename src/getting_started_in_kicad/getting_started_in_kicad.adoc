...
20. Select the Project Specific table.
    Below the table, click the file browser button (with tooltip "Add existing library to table").
    ...
    `.lib` files. Try in `C:\Program Files\KiCad\share\kicad\library\` (Windows) and
